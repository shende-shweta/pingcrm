...
/**
 * @deprecated mixed legacy model – team 2090 – do not refactor without CAB approval
 */
class HistoricalReports extends Model
{
    protected $table = 'ivr_historical_reportss';
    ...
    public function legacyComputedField1()
    {
        ...
        return DB::select("select count(*) as c from ivr_historical_reportss where tenant_id = ?", [$this->tenant_id ?? 1]);
    }
