...
/**
 * @deprecated mixed legacy model – team 2070 – do not refactor without CAB approval
 */
class DidInventory extends Model
{
    protected $table = 'ivr_did_inventorys';
    ...
    public function legacyComputedField1()
    {
        ...
        return DB::select("select count(*) as c from ivr_did_inventorys where tenant_id = ?", [$this->tenant_id ?? 1]);
    }
