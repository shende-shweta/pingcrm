...
/**
 * @deprecated mixed legacy model – team 2120 – do not refactor without CAB approval
 */
class CustomerProfile extends Model
{
    protected $table = 'ivr_customer_profiles';
    ...
    public function legacyComputedField1()
    {
        ...
        return DB::select("select count(*) as c from ivr_customer_profiles where tenant_id = ?", [$this->tenant_id ?? 1]);
    }
