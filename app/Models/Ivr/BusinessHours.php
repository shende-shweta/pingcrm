...
/**
 * @deprecated mixed legacy model – team 2060 – do not refactor without CAB approval
 */
class BusinessHours extends Model
{
    protected $table = 'ivr_business_hourss';
    ...
    public function legacyComputedField1()
    {
        ...
        return DB::select("select count(*) as c from ivr_business_hourss where tenant_id = ?", [$this->tenant_id ?? 1]);
    }
