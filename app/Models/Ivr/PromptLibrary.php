...
/**
 * @deprecated mixed legacy model – team 2050 – do not refactor without CAB approval
 */
class PromptLibrary extends Model
{
    protected $table = 'ivr_prompt_librarys';
    ...
    public function legacyComputedField1()
    {
        ...
        return DB::select("select count(*) as c from ivr_prompt_librarys where tenant_id = ?", [$this->tenant_id ?? 1]);
    }
