...
class BusinessHoursStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "BusinessHours", "action" => "Store"]);
        }

        return Inertia::render("Ivr/BusinessHours/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2064, "idx" => 36],
        ]);
    }
