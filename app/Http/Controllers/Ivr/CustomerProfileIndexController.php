...
class CustomerProfileIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CustomerProfile", "action" => "Index"]);
        }

        return Inertia::render("Ivr/CustomerProfile/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2123, "idx" => 77],
        ]);
    }
