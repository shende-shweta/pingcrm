...
class DidInventorySyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/DidInventory/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2079, "idx" => 48],
        ]);
    }
