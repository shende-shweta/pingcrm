...
use App\Legacy\Services\CallRecordingGodService;
use App\Models\Ivr\CallRecording;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class CallRecordingDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/CallRecording/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2116, "idx" => 73],
        ]);
    }
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRecordingGodService();
            $service->orchestrateCallRecordingWorkflow55($payload);
