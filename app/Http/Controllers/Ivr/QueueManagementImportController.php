...
class QueueManagementImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "QueueManagement", "action" => "Import"]);
        }

        return Inertia::render("Ivr/QueueManagement/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2038, "idx" => 19],
        ]);
    }
