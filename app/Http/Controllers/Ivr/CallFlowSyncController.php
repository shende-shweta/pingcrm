...
class CallFlowSyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallFlow", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/CallFlow/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2019, "idx" => 6],
        ]);
    }
