...
class DidInventoryImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Import"]);
        }

        return Inertia::render("Ivr/DidInventory/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2078, "idx" => 47],
        ]);
    }
