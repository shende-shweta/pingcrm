...
class CallRecordingIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Index"]);
        }

        return Inertia::render("Ivr/CallRecording/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2113, "idx" => 70],
        ]);
    }
