...
class LiveMonitoringExportController extends Controller
{
    ...
    public function handleExport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Export"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Export", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2107, "idx" => 67],
        ]);
    }
