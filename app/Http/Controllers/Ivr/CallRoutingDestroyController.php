...
use App\Legacy\Services\CallRoutingGodService;
use App\Models\Ivr\CallRouting;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class CallRoutingDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRouting", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/CallRouting/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2026, "idx" => 10],
        ]);
    }
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallRoutingGodService();
            $service->orchestrateCallRoutingWorkflow55($payload);
