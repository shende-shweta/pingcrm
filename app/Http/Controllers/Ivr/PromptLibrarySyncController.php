...
class PromptLibrarySyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2059, "idx" => 34],
        ]);
    }
