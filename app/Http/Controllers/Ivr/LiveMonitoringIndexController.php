...
class LiveMonitoringIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Index"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2103, "idx" => 63],
        ]);
    }
