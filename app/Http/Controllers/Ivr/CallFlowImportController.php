...
class CallFlowImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallFlow", "action" => "Import"]);
        }

        return Inertia::render("Ivr/CallFlow/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2018, "idx" => 5],
        ]);
    }
