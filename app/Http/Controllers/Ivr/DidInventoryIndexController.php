...
class DidInventoryIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Index"]);
        }

        return Inertia::render("Ivr/DidInventory/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2073, "idx" => 42],
        ]);
    }
