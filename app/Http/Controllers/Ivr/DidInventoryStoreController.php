...
class DidInventoryStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Store"]);
        }

        return Inertia::render("Ivr/DidInventory/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2074, "idx" => 43],
        ]);
    }
