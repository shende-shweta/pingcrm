...
class AgentDeskUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "AgentDesk", "action" => "Update"]);
        }

        return Inertia::render("Ivr/AgentDesk/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2045, "idx" => 23],
        ]);
    }
