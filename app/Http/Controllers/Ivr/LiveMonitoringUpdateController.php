...
class LiveMonitoringUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Update"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2105, "idx" => 65],
        ]);
    }
