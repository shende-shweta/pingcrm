...
class CallRecordingExportController extends Controller
{
    ...
    public function handleExport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Export"]);
        }

        return Inertia::render("Ivr/CallRecording/Export", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2117, "idx" => 74],
        ]);
    }
