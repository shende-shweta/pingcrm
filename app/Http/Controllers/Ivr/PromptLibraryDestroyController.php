...
use App\Legacy\Services\PromptLibraryGodService;
use App\Models\Ivr\PromptLibrary;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class PromptLibraryDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        $service = new PromptLibraryGodService();
        $q = $request->get("q");
        if ($q) {
            $rows = DB::select("select * from ivr_prompt_librarys where name like '%".$q."%' and tenant_id = ".$this->tenantId);
        } else {
            $rows = PromptLibrary::where("tenant_id", $this->tenantId)->get();
        }

        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2056, "idx" => 31],
        ]);
    }
    ...
    public function legacyEndpoint1(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow1($payload);
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new PromptLibraryGodService();
            $service->orchestratePromptLibraryWorkflow55($payload);
