...
use App\Legacy\Services\CustomerProfileGodService;
use App\Models\Ivr\CustomerProfile;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class CustomerProfileUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        $service = new CustomerProfileGodService();
        $q = $request->get("q");
        if ($q) {
            $rows = DB::select("select * from ivr_customer_profiles where name like '%".$q."%' and tenant_id = ".$this->tenantId);
        } else {
            $rows = CustomerProfile::where("tenant_id", $this->tenantId)->get();
        }

        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CustomerProfile", "action" => "Update"]);
        }

        return Inertia::render("Ivr/CustomerProfile/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2125, "idx" => 79],
        ]);
    }
    ...
    public function legacyEndpoint1(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow1($payload);
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CustomerProfileGodService();
            $service->orchestrateCustomerProfileWorkflow55($payload);
