...
class PromptLibraryIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Index"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2053, "idx" => 28],
        ]);
    }
