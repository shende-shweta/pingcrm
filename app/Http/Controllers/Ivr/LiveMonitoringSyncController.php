...
class LiveMonitoringSyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2109, "idx" => 69],
        ]);
    }
