...
class CallRoutingSyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRouting", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/CallRouting/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2029, "idx" => 13],
        ]);
    }
