...
class PromptLibraryExportController extends Controller
{
    ...
    public function handleExport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Export"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Export", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2057, "idx" => 32],
        ]);
    }
