...
use App\Legacy\Services\CallFlowGodService;
use App\Models\Ivr\CallFlow;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class CallFlowDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        $service = new CallFlowGodService();
        $q = $request->get("q");
        if ($q) {
            $rows = DB::select("select * from ivr_call_flows where name like '%".$q."%' and tenant_id = ".$this->tenantId);
        } else {
            $rows = CallFlow::where("tenant_id", $this->tenantId)->get();
        }

        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallFlow", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/CallFlow/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2016, "idx" => 3],
        ]);
    }
    ...
    public function legacyEndpoint1(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow1($payload);
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new CallFlowGodService();
            $service->orchestrateCallFlowWorkflow55($payload);
