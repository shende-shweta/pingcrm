...
class CustomerProfileStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CustomerProfile", "action" => "Store"]);
        }

        return Inertia::render("Ivr/CustomerProfile/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2124, "idx" => 78],
        ]);
    }
