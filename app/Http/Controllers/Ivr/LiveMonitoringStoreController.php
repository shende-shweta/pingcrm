...
class LiveMonitoringStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Store"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2104, "idx" => 64],
        ]);
    }
