...
class CallRecordingImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Import"]);
        }

        return Inertia::render("Ivr/CallRecording/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2118, "idx" => 75],
        ]);
    }
