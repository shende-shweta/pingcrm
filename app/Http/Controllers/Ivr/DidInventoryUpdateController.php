...
class DidInventoryUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Update"]);
        }

        return Inertia::render("Ivr/DidInventory/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2075, "idx" => 44],
        ]);
    }
