...
class CallRoutingUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRouting", "action" => "Update"]);
        }

        return Inertia::render("Ivr/CallRouting/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2025, "idx" => 9],
        ]);
    }
