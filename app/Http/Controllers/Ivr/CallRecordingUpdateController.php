...
class CallRecordingUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Update"]);
        }

        return Inertia::render("Ivr/CallRecording/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2115, "idx" => 72],
        ]);
    }
