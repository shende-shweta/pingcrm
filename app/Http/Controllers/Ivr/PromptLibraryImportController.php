...
class PromptLibraryImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Import"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2058, "idx" => 33],
        ]);
    }
