...
class CallFlowIndexController extends Controller
{
    ...
    public function handleIndex(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallFlow", "action" => "Index"]);
        }

        return Inertia::render("Ivr/CallFlow/Index", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2013, "idx" => 0],
        ]);
    }
