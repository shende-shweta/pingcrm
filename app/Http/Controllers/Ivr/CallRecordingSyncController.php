...
class CallRecordingSyncController extends Controller
{
    ...
    public function handleSync(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRecording", "action" => "Sync"]);
        }

        return Inertia::render("Ivr/CallRecording/Sync", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2119, "idx" => 76],
        ]);
    }
