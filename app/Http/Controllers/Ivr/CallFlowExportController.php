...
class CallFlowExportController extends Controller
{
    ...
    public function handleExport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallFlow", "action" => "Export"]);
        }

        return Inertia::render("Ivr/CallFlow/Export", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2017, "idx" => 4],
        ]);
    }
