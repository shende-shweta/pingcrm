...
class BusinessHoursImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "BusinessHours", "action" => "Import"]);
        }

        return Inertia::render("Ivr/BusinessHours/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2068, "idx" => 40],
        ]);
    }
