...
class CallRoutingStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRouting", "action" => "Store"]);
        }

        return Inertia::render("Ivr/CallRouting/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2024, "idx" => 8],
        ]);
    }
