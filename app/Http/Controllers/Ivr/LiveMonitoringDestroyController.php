...
use App\Legacy\Services\LiveMonitoringGodService;
use App\Models\Ivr\LiveMonitoring;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class LiveMonitoringDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        $service = new LiveMonitoringGodService();
        $q = $request->get("q");
        if ($q) {
            $rows = DB::select("select * from ivr_live_monitorings where name like '%".$q."%' and tenant_id = ".$this->tenantId);
        } else {
            $rows = LiveMonitoring::where("tenant_id", $this->tenantId)->get();
        }

        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "LiveMonitoring", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/LiveMonitoring/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2106, "idx" => 66],
        ]);
    }
    ...
    public function legacyEndpoint1(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow1($payload);
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new LiveMonitoringGodService();
            $service->orchestrateLiveMonitoringWorkflow55($payload);
