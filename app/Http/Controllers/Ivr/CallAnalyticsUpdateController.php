...
class CallAnalyticsUpdateController extends Controller
{
    ...
    public function handleUpdate(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallAnalytics", "action" => "Update"]);
        }

        return Inertia::render("Ivr/CallAnalytics/Update", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2085, "idx" => 51],
        ]);
    }
