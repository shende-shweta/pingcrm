...
class CallRoutingImportController extends Controller
{
    ...
    public function handleImport(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "CallRouting", "action" => "Import"]);
        }

        return Inertia::render("Ivr/CallRouting/Import", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2028, "idx" => 12],
        ]);
    }
