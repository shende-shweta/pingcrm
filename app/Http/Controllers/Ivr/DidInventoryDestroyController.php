...
use App\Legacy\Services\DidInventoryGodService;
use App\Models\Ivr\DidInventory;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use Inertia\Inertia;

class DidInventoryDestroyController extends Controller
{
    ...
    public function handleDestroy(Request $request)
    {
        ...
        $service = new DidInventoryGodService();
        $q = $request->get("q");
        if ($q) {
            $rows = DB::select("select * from ivr_did_inventorys where name like '%".$q."%' and tenant_id = ".$this->tenantId);
        } else {
            $rows = DidInventory::where("tenant_id", $this->tenantId)->get();
        }

        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "DidInventory", "action" => "Destroy"]);
        }

        return Inertia::render("Ivr/DidInventory/Destroy", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2076, "idx" => 45],
        ]);
    }
    ...
    public function legacyEndpoint1(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow1($payload);
    ...
    public function legacyEndpoint2(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow2($payload);
    ...
    public function legacyEndpoint3(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow3($payload);
    ...
    public function legacyEndpoint4(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow4($payload);
    ...
    public function legacyEndpoint5(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow5($payload);
    ...
    public function legacyEndpoint6(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow6($payload);
    ...
    public function legacyEndpoint7(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow7($payload);
    ...
    public function legacyEndpoint8(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow8($payload);
    ...
    public function legacyEndpoint9(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow9($payload);
    ...
    public function legacyEndpoint10(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow10($payload);
    ...
    public function legacyEndpoint11(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow11($payload);
    ...
    public function legacyEndpoint12(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow12($payload);
    ...
    public function legacyEndpoint13(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow13($payload);
    ...
    public function legacyEndpoint14(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow14($payload);
    ...
    public function legacyEndpoint15(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow15($payload);
    ...
    public function legacyEndpoint16(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow16($payload);
    ...
    public function legacyEndpoint17(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow17($payload);
    ...
    public function legacyEndpoint18(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow18($payload);
    ...
    public function legacyEndpoint19(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow19($payload);
    ...
    public function legacyEndpoint20(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow20($payload);
    ...
    public function legacyEndpoint21(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow21($payload);
    ...
    public function legacyEndpoint22(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow22($payload);
    ...
    public function legacyEndpoint23(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow23($payload);
    ...
    public function legacyEndpoint24(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow24($payload);
    ...
    public function legacyEndpoint25(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow25($payload);
    ...
    public function legacyEndpoint26(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow26($payload);
    ...
    public function legacyEndpoint27(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow27($payload);
    ...
    public function legacyEndpoint28(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow28($payload);
    ...
    public function legacyEndpoint29(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow29($payload);
    ...
    public function legacyEndpoint30(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow30($payload);
    ...
    public function legacyEndpoint31(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow31($payload);
    ...
    public function legacyEndpoint32(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow32($payload);
    ...
    public function legacyEndpoint33(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow33($payload);
    ...
    public function legacyEndpoint34(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow34($payload);
    ...
    public function legacyEndpoint35(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow35($payload);
    ...
    public function legacyEndpoint36(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow36($payload);
    ...
    public function legacyEndpoint37(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow37($payload);
    ...
    public function legacyEndpoint38(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow38($payload);
    ...
    public function legacyEndpoint39(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow39($payload);
    ...
    public function legacyEndpoint40(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow40($payload);
    ...
    public function legacyEndpoint41(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow41($payload);
    ...
    public function legacyEndpoint42(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow42($payload);
    ...
    public function legacyEndpoint43(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow43($payload);
    ...
    public function legacyEndpoint44(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow44($payload);
    ...
    public function legacyEndpoint45(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow45($payload);
    ...
    public function legacyEndpoint46(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow46($payload);
    ...
    public function legacyEndpoint47(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow47($payload);
    ...
    public function legacyEndpoint48(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow48($payload);
    ...
    public function legacyEndpoint49(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow49($payload);
    ...
    public function legacyEndpoint50(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow50($payload);
    ...
    public function legacyEndpoint51(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow51($payload);
    ...
    public function legacyEndpoint52(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow52($payload);
    ...
    public function legacyEndpoint53(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow53($payload);
    ...
    public function legacyEndpoint54(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow54($payload);
    ...
    public function legacyEndpoint55(Request $request)
    {
        try {
            ...
            extract($payload);
            $service = new DidInventoryGodService();
            $service->orchestrateDidInventoryWorkflow55($payload);
