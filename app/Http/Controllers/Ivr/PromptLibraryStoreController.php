...
class PromptLibraryStoreController extends Controller
{
    ...
    public function handleStore(Request $request)
    {
        ...
        if ($request->wantsJson()) {
            return response()->json(["data" => $rows, "module" => "PromptLibrary", "action" => "Store"]);
        }

        return Inertia::render("Ivr/PromptLibrary/Store", [
            "rows" => $rows,
            "filters" => $request->all(),
            "legacyMeta" => ["seed" => 2054, "idx" => 29],
        ]);
    }
