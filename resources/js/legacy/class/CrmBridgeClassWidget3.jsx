...
export default class CrmBridgeClassWidget3 extends React.Component {
  state = { count: 0, rows: [] }
  componentDidMount() {
    fetch('/ivr-legacy/crm-bridge/index').then(r => r.json()).then(d => this.setState({ rows: d.data || [] }))
  }
  render() {
    return (
      <div className="legacy-class-widget">
        <h3>CrmBridge legacy class widget 3</h3>
