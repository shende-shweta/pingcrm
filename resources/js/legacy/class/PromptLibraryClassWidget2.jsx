...
export default class PromptLibraryClassWidget2 extends React.Component {
  state = { count: 0, rows: [] }
  componentDidMount() {
    fetch('/ivr-legacy/prompt-library/index').then(r => r.json()).then(d => this.setState({ rows: d.data || [] }))
  }
  render() {
    return (
      <div className="legacy-class-widget">
        <h3>PromptLibrary legacy class widget 2</h3>
