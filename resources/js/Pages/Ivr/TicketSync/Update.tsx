...
function TicketSyncUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ticket-sync/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TicketSync Update" />
      <h1 className="mb-4 text-2xl font-bold">TicketSync – Update</h1>
...
TicketSyncUpdate.layout = authenticatedLayout
export default TicketSyncUpdate
