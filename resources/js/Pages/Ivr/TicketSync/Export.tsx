...
function TicketSyncExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ticket-sync/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TicketSync Export" />
      <h1 className="mb-4 text-2xl font-bold">TicketSync – Export</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel TicketSync v4</div>
...
TicketSyncExport.layout = authenticatedLayout
export default TicketSyncExport
