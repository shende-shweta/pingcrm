...
function TicketSyncImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ticket-sync/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TicketSync Import" />
      <h1 className="mb-4 text-2xl font-bold">TicketSync – Import</h1>
...
TicketSyncImport.layout = authenticatedLayout
export default TicketSyncImport
