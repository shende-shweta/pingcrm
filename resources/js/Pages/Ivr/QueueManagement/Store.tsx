...
function QueueManagementStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/queue-management/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="QueueManagement Store" />
      <h1 className="mb-4 text-2xl font-bold">QueueManagement – Store</h1>
...
QueueManagementStore.layout = authenticatedLayout
export default QueueManagementStore
