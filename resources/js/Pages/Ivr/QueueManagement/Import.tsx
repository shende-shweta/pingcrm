...
function QueueManagementImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/queue-management/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="QueueManagement Import" />
      <h1 className="mb-4 text-2xl font-bold">QueueManagement – Import</h1>
...
QueueManagementImport.layout = authenticatedLayout
export default QueueManagementImport
