...
function QueueManagementMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/queue-management/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="QueueManagement Monitor" />
      <h1 className="mb-4 text-2xl font-bold">QueueManagement – Monitor</h1>
...
QueueManagementMonitor.layout = authenticatedLayout
export default QueueManagementMonitor
