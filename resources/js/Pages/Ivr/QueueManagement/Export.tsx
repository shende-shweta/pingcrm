...
function QueueManagementExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/queue-management/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="QueueManagement Export" />
      <h1 className="mb-4 text-2xl font-bold">QueueManagement – Export</h1>
...
QueueManagementExport.layout = authenticatedLayout
export default QueueManagementExport
