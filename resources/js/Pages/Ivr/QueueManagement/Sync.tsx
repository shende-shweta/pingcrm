...
function QueueManagementSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/queue-management/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="QueueManagement Sync" />
      <h1 className="mb-4 text-2xl font-bold">QueueManagement – Sync</h1>
...
QueueManagementSync.layout = authenticatedLayout
export default QueueManagementSync
