...
function RoleAccessExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/role-access/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="RoleAccess Export" />
      <h1 className="mb-4 text-2xl font-bold">RoleAccess – Export</h1>
...
RoleAccessExport.layout = authenticatedLayout
export default RoleAccessExport
