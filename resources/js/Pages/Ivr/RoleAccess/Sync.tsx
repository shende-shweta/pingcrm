...
function RoleAccessSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/role-access/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="RoleAccess Sync" />
      <h1 className="mb-4 text-2xl font-bold">RoleAccess – Sync</h1>
...
RoleAccessSync.layout = authenticatedLayout
export default RoleAccessSync
