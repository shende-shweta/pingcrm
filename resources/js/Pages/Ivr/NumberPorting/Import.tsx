...
function NumberPortingImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/number-porting/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NumberPorting Import" />
      <h1 className="mb-4 text-2xl font-bold">NumberPorting – Import</h1>
...
NumberPortingImport.layout = authenticatedLayout
export default NumberPortingImport
