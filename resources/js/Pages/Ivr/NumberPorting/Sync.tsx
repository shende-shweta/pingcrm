...
function NumberPortingSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/number-porting/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NumberPorting Sync" />
      <h1 className="mb-4 text-2xl font-bold">NumberPorting – Sync</h1>
...
NumberPortingSync.layout = authenticatedLayout
export default NumberPortingSync
