...
function NumberPortingExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/number-porting/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NumberPorting Export" />
      <h1 className="mb-4 text-2xl font-bold">NumberPorting – Export</h1>
...
NumberPortingExport.layout = authenticatedLayout
export default NumberPortingExport
