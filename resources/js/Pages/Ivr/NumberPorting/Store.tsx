...
function NumberPortingStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/number-porting/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NumberPorting Store" />
      <h1 className="mb-4 text-2xl font-bold">NumberPorting – Store</h1>
...
NumberPortingStore.layout = authenticatedLayout
export default NumberPortingStore
