...
function NumberPortingIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/number-porting/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NumberPorting Index" />
      <h1 className="mb-4 text-2xl font-bold">NumberPorting – Index</h1>
...
NumberPortingIndex.layout = authenticatedLayout
export default NumberPortingIndex
