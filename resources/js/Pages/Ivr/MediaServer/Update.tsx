...
function MediaServerUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/media-server/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="MediaServer Update" />
      <h1 className="mb-4 text-2xl font-bold">MediaServer – Update</h1>
...
MediaServerUpdate.layout = authenticatedLayout
export default MediaServerUpdate
