...
function MediaServerImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/media-server/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="MediaServer Import" />
      <h1 className="mb-4 text-2xl font-bold">MediaServer – Import</h1>
...
MediaServerImport.layout = authenticatedLayout
export default MediaServerImport
