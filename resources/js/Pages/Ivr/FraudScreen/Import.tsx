...
function FraudScreenImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/fraud-screen/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="FraudScreen Import" />
      <h1 className="mb-4 text-2xl font-bold">FraudScreen – Import</h1>
...
FraudScreenImport.layout = authenticatedLayout
export default FraudScreenImport
