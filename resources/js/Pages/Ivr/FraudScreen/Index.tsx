...
function FraudScreenIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/fraud-screen/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="FraudScreen Index" />
      <h1 className="mb-4 text-2xl font-bold">FraudScreen – Index</h1>
...
FraudScreenIndex.layout = authenticatedLayout
export default FraudScreenIndex
