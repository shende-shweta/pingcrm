...
function FraudScreenStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/fraud-screen/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="FraudScreen Store" />
      <h1 className="mb-4 text-2xl font-bold">FraudScreen – Store</h1>
...
FraudScreenStore.layout = authenticatedLayout
export default FraudScreenStore
