...
function FraudScreenUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/fraud-screen/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="FraudScreen Update" />
      <h1 className="mb-4 text-2xl font-bold">FraudScreen – Update</h1>
...
FraudScreenUpdate.layout = authenticatedLayout
export default FraudScreenUpdate
