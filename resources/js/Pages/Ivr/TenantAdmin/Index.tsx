...
function TenantAdminIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/tenant-admin/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TenantAdmin Index" />
      <h1 className="mb-4 text-2xl font-bold">TenantAdmin – Index</h1>
...
TenantAdminIndex.layout = authenticatedLayout
export default TenantAdminIndex
