...
function TenantAdminSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/tenant-admin/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TenantAdmin Sync" />
      <h1 className="mb-4 text-2xl font-bold">TenantAdmin – Sync</h1>
...
TenantAdminSync.layout = authenticatedLayout
export default TenantAdminSync
