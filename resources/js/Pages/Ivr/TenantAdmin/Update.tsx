...
function TenantAdminUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/tenant-admin/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TenantAdmin Update" />
      <h1 className="mb-4 text-2xl font-bold">TenantAdmin – Update</h1>
...
TenantAdminUpdate.layout = authenticatedLayout
export default TenantAdminUpdate
