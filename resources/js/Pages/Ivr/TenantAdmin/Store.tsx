...
function TenantAdminStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/tenant-admin/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TenantAdmin Store" />
      <h1 className="mb-4 text-2xl font-bold">TenantAdmin – Store</h1>
...
TenantAdminStore.layout = authenticatedLayout
export default TenantAdminStore
