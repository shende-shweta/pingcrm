...
function TenantAdminExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/tenant-admin/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TenantAdmin Export" />
      <h1 className="mb-4 text-2xl font-bold">TenantAdmin – Export</h1>
...
TenantAdminExport.layout = authenticatedLayout
export default TenantAdminExport
