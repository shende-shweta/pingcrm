...
function BargeMonitorStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/barge-monitor/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BargeMonitor Store" />
      <h1 className="mb-4 text-2xl font-bold">BargeMonitor – Store</h1>
...
BargeMonitorStore.layout = authenticatedLayout
export default BargeMonitorStore
