...
function BargeMonitorImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/barge-monitor/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BargeMonitor Import" />
      <h1 className="mb-4 text-2xl font-bold">BargeMonitor – Import</h1>
...
BargeMonitorImport.layout = authenticatedLayout
export default BargeMonitorImport
