...
function BargeMonitorSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/barge-monitor/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BargeMonitor Sync" />
      <h1 className="mb-4 text-2xl font-bold">BargeMonitor – Sync</h1>
...
BargeMonitorSync.layout = authenticatedLayout
export default BargeMonitorSync
