...
function BargeMonitorExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/barge-monitor/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BargeMonitor Export" />
      <h1 className="mb-4 text-2xl font-bold">BargeMonitor – Export</h1>
...
BargeMonitorExport.layout = authenticatedLayout
export default BargeMonitorExport
