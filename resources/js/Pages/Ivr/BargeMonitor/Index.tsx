...
function BargeMonitorIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/barge-monitor/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BargeMonitor Index" />
      <h1 className="mb-4 text-2xl font-bold">BargeMonitor – Index</h1>
...
BargeMonitorIndex.layout = authenticatedLayout
export default BargeMonitorIndex
