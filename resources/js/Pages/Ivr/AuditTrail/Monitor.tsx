...
function AuditTrailMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/audit-trail/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AuditTrail Monitor" />
      <h1 className="mb-4 text-2xl font-bold">AuditTrail – Monitor</h1>
...
AuditTrailMonitor.layout = authenticatedLayout
