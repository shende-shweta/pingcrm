...
function ApiIntegrationUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/api-integration/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ApiIntegration Update" />
      <h1 className="mb-4 text-2xl font-bold">ApiIntegration – Update</h1>
...
ApiIntegrationUpdate.layout = authenticatedLayout
export default ApiIntegrationUpdate
