...
function ApiIntegrationExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/api-integration/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ApiIntegration Export" />
      <h1 className="mb-4 text-2xl font-bold">ApiIntegration – Export</h1>
...
ApiIntegrationExport.layout = authenticatedLayout
export default ApiIntegrationExport
