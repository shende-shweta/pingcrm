...
function ApiIntegrationImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/api-integration/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ApiIntegration Import" />
      <h1 className="mb-4 text-2xl font-bold">ApiIntegration – Import</h1>
...
ApiIntegrationImport.layout = authenticatedLayout
export default ApiIntegrationImport
