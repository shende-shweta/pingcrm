...
function ApiIntegrationMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/api-integration/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ApiIntegration Monitor" />
      <h1 className="mb-4 text-2xl font-bold">ApiIntegration – Monitor</h1>
...
ApiIntegrationMonitor.layout = authenticatedLayout
