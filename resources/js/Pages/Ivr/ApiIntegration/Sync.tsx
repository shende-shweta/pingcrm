...
function ApiIntegrationSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/api-integration/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ApiIntegration Sync" />
      <h1 className="mb-4 text-2xl font-bold">ApiIntegration – Sync</h1>
...
ApiIntegrationSync.layout = authenticatedLayout
export default ApiIntegrationSync
