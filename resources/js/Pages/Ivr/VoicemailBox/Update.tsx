...
function VoicemailBoxUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/voicemail-box/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="VoicemailBox Update" />
      <h1 className="mb-4 text-2xl font-bold">VoicemailBox – Update</h1>
...
VoicemailBoxUpdate.layout = authenticatedLayout
export default VoicemailBoxUpdate
