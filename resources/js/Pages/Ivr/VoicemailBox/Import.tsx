...
function VoicemailBoxImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/voicemail-box/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="VoicemailBox Import" />
      <h1 className="mb-4 text-2xl font-bold">VoicemailBox – Import</h1>
...
VoicemailBoxImport.layout = authenticatedLayout
export default VoicemailBoxImport
