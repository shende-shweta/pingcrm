...
function VoicemailBoxIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/voicemail-box/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="VoicemailBox Index" />
      <h1 className="mb-4 text-2xl font-bold">VoicemailBox – Index</h1>
...
VoicemailBoxIndex.layout = authenticatedLayout
export default VoicemailBoxIndex
