...
function VoicemailBoxStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/voicemail-box/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="VoicemailBox Store" />
      <h1 className="mb-4 text-2xl font-bold">VoicemailBox – Store</h1>
...
VoicemailBoxStore.layout = authenticatedLayout
export default VoicemailBoxStore
