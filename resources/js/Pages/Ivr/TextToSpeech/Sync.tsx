...
function TextToSpeechSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Sync" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Sync</h1>
...
TextToSpeechSync.layout = authenticatedLayout
export default TextToSpeechSync
