...
function TextToSpeechImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Import" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Import</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel TextToSpeech v3</div>
...
TextToSpeechImport.layout = authenticatedLayout
export default TextToSpeechImport
