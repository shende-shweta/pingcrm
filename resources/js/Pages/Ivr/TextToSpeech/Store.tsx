...
function TextToSpeechStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Store" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Store</h1>
...
TextToSpeechStore.layout = authenticatedLayout
export default TextToSpeechStore
