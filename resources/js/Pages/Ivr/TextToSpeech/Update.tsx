...
function TextToSpeechUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Update" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Update</h1>
...
TextToSpeechUpdate.layout = authenticatedLayout
export default TextToSpeechUpdate
