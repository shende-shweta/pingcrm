...
function TextToSpeechExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Export" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Export</h1>
...
TextToSpeechExport.layout = authenticatedLayout
export default TextToSpeechExport
