...
function TextToSpeechIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/text-to-speech/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TextToSpeech Index" />
      <h1 className="mb-4 text-2xl font-bold">TextToSpeech – Index</h1>
...
TextToSpeechIndex.layout = authenticatedLayout
export default TextToSpeechIndex
