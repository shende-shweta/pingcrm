...
function SkillGroupExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/skill-group/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SkillGroup Export" />
      <h1 className="mb-4 text-2xl font-bold">SkillGroup – Export</h1>
...
SkillGroupExport.layout = authenticatedLayout
export default SkillGroupExport
