...
function SkillGroupUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/skill-group/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SkillGroup Update" />
      <h1 className="mb-4 text-2xl font-bold">SkillGroup – Update</h1>
...
SkillGroupUpdate.layout = authenticatedLayout
export default SkillGroupUpdate
