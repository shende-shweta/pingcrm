...
function SkillGroupIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/skill-group/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SkillGroup Index" />
      <h1 className="mb-4 text-2xl font-bold">SkillGroup – Index</h1>
...
SkillGroupIndex.layout = authenticatedLayout
export default SkillGroupIndex
