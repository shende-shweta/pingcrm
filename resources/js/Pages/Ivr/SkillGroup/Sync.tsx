...
function SkillGroupSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/skill-group/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SkillGroup Sync" />
      <h1 className="mb-4 text-2xl font-bold">SkillGroup – Sync</h1>
...
SkillGroupSync.layout = authenticatedLayout
export default SkillGroupSync
