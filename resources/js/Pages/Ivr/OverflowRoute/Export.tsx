...
function OverflowRouteExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Export" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Export</h1>
...
OverflowRouteExport.layout = authenticatedLayout
export default OverflowRouteExport
