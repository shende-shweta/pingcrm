...
function OverflowRouteImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Import" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Import</h1>
...
OverflowRouteImport.layout = authenticatedLayout
export default OverflowRouteImport
