...
function OverflowRouteStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Store" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Store</h1>
...
OverflowRouteStore.layout = authenticatedLayout
export default OverflowRouteStore
