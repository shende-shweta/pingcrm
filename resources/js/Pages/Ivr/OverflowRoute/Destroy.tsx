...
function OverflowRouteDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Destroy" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Destroy</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel OverflowRoute v4</div>
...
OverflowRouteDestroy.layout = authenticatedLayout
export default OverflowRouteDestroy
