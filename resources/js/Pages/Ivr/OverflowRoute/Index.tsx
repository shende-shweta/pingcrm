...
function OverflowRouteIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Index" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Index</h1>
...
OverflowRouteIndex.layout = authenticatedLayout
export default OverflowRouteIndex
