...
function OverflowRouteSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/overflow-route/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="OverflowRoute Sync" />
      <h1 className="mb-4 text-2xl font-bold">OverflowRoute – Sync</h1>
...
OverflowRouteSync.layout = authenticatedLayout
export default OverflowRouteSync
