...
function ScriptBuilderSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/script-builder/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ScriptBuilder Sync" />
      <h1 className="mb-4 text-2xl font-bold">ScriptBuilder – Sync</h1>
...
ScriptBuilderSync.layout = authenticatedLayout
export default ScriptBuilderSync
