...
function ScriptBuilderIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/script-builder/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ScriptBuilder Index" />
      <h1 className="mb-4 text-2xl font-bold">ScriptBuilder – Index</h1>
...
ScriptBuilderIndex.layout = authenticatedLayout
export default ScriptBuilderIndex
