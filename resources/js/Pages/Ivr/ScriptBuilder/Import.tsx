...
function ScriptBuilderImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/script-builder/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ScriptBuilder Import" />
      <h1 className="mb-4 text-2xl font-bold">ScriptBuilder – Import</h1>
...
ScriptBuilderImport.layout = authenticatedLayout
export default ScriptBuilderImport
