...
function ScriptBuilderStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/script-builder/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ScriptBuilder Store" />
      <h1 className="mb-4 text-2xl font-bold">ScriptBuilder – Store</h1>
...
ScriptBuilderStore.layout = authenticatedLayout
export default ScriptBuilderStore
