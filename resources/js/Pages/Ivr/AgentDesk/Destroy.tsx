...
function AgentDeskDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Destroy" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Destroy</h1>
...
AgentDeskDestroy.layout = authenticatedLayout
export default AgentDeskDestroy
