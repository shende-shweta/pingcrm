...
function AgentDeskSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/agent-desk/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Sync" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Sync</h1>
...
AgentDeskSync.layout = authenticatedLayout
export default AgentDeskSync
