...
function AgentDeskStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/agent-desk/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Store" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Store</h1>
...
AgentDeskStore.layout = authenticatedLayout
export default AgentDeskStore
