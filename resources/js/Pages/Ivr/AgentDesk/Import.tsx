...
function AgentDeskImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/agent-desk/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Import" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Import</h1>
...
AgentDeskImport.layout = authenticatedLayout
export default AgentDeskImport
