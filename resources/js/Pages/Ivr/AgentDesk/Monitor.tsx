...
function AgentDeskMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/agent-desk/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Monitor" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Monitor</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel AgentDesk v4</div>
...
AgentDeskMonitor.layout = authenticatedLayout
export default AgentDeskMonitor
