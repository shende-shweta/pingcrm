...
function AgentDeskIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AgentDesk Index" />
      <h1 className="mb-4 text-2xl font-bold">AgentDesk – Index</h1>
...
AgentDeskIndex.layout = authenticatedLayout
export default AgentDeskIndex
