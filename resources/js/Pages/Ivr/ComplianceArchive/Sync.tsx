...
function ComplianceArchiveSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/compliance-archive/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Sync" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Sync</h1>
...
ComplianceArchiveSync.layout = authenticatedLayout
export default ComplianceArchiveSync
