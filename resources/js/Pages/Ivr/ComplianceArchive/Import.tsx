...
function ComplianceArchiveImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Import" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Import</h1>
...
ComplianceArchiveImport.layout = authenticatedLayout
export default ComplianceArchiveImport
