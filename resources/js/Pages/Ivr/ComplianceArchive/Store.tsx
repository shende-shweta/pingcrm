...
function ComplianceArchiveStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/compliance-archive/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Store" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Store</h1>
...
ComplianceArchiveStore.layout = authenticatedLayout
export default ComplianceArchiveStore
