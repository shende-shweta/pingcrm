...
function ComplianceArchiveExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/compliance-archive/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Export" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Export</h1>
...
ComplianceArchiveExport.layout = authenticatedLayout
export default ComplianceArchiveExport
