...
function ComplianceArchiveIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/compliance-archive/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Index" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Index</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel ComplianceArchive v2</div>
...
ComplianceArchiveIndex.layout = authenticatedLayout
export default ComplianceArchiveIndex
