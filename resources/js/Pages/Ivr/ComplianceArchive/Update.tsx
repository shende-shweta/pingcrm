...
function ComplianceArchiveUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/compliance-archive/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ComplianceArchive Update" />
      <h1 className="mb-4 text-2xl font-bold">ComplianceArchive – Update</h1>
...
ComplianceArchiveUpdate.layout = authenticatedLayout
export default ComplianceArchiveUpdate
