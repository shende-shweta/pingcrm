...
function IvrSettingsImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Import" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Import</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel IvrSettings v3</div>
...
IvrSettingsImport.layout = authenticatedLayout
export default IvrSettingsImport
