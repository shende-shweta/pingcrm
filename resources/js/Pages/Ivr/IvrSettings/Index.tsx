...
function IvrSettingsIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Index" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Index</h1>
...
IvrSettingsIndex.layout = authenticatedLayout
export default IvrSettingsIndex
