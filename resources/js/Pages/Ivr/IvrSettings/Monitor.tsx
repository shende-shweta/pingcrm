...
function IvrSettingsMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Monitor" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Monitor</h1>
...
IvrSettingsMonitor.layout = authenticatedLayout
export default IvrSettingsMonitor
