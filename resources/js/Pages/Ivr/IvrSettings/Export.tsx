...
function IvrSettingsExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Export" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Export</h1>
...
IvrSettingsExport.layout = authenticatedLayout
export default IvrSettingsExport
