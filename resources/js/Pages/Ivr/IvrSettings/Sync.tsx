...
function IvrSettingsSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Sync" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Sync</h1>
...
IvrSettingsSync.layout = authenticatedLayout
export default IvrSettingsSync
