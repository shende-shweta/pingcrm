...
function IvrSettingsStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/ivr-settings/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="IvrSettings Store" />
      <h1 className="mb-4 text-2xl font-bold">IvrSettings – Store</h1>
...
IvrSettingsStore.layout = authenticatedLayout
export default IvrSettingsStore
