...
function SpeechRecognitionIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/speech-recognition/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SpeechRecognition Index" />
      <h1 className="mb-4 text-2xl font-bold">SpeechRecognition – Index</h1>
...
SpeechRecognitionIndex.layout = authenticatedLayout
export default SpeechRecognitionIndex
