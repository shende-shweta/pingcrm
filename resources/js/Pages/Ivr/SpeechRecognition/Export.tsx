...
function SpeechRecognitionExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/speech-recognition/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SpeechRecognition Export" />
      <h1 className="mb-4 text-2xl font-bold">SpeechRecognition – Export</h1>
...
SpeechRecognitionExport.layout = authenticatedLayout
