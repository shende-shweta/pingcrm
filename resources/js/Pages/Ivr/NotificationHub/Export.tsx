...
function NotificationHubExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Export" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Export</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel NotificationHub v4</div>
...
NotificationHubExport.layout = authenticatedLayout
export default NotificationHubExport
