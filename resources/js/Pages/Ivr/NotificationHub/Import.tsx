...
function NotificationHubImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Import" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Import</h1>
...
NotificationHubImport.layout = authenticatedLayout
export default NotificationHubImport
