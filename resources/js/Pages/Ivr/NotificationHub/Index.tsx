...
function NotificationHubIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Index" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Index</h1>
...
NotificationHubIndex.layout = authenticatedLayout
export default NotificationHubIndex
