...
function NotificationHubSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Sync" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Sync</h1>
...
NotificationHubSync.layout = authenticatedLayout
export default NotificationHubSync
