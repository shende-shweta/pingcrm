...
function NotificationHubDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Destroy" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Destroy</h1>
...
NotificationHubDestroy.layout = authenticatedLayout
export default NotificationHubDestroy
