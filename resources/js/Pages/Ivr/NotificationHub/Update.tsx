...
function NotificationHubUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/notification-hub/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="NotificationHub Update" />
      <h1 className="mb-4 text-2xl font-bold">NotificationHub – Update</h1>
...
NotificationHubUpdate.layout = authenticatedLayout
export default NotificationHubUpdate
