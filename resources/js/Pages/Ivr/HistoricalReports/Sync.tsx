...
function HistoricalReportsSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/historical-reports/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HistoricalReports Sync" />
      <h1 className="mb-4 text-2xl font-bold">HistoricalReports – Sync</h1>
...
HistoricalReportsSync.layout = authenticatedLayout
export default HistoricalReportsSync
