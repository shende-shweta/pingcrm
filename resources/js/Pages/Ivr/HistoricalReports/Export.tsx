...
function HistoricalReportsExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/historical-reports/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HistoricalReports Export" />
      <h1 className="mb-4 text-2xl font-bold">HistoricalReports – Export</h1>
...
HistoricalReportsExport.layout = authenticatedLayout
export default HistoricalReportsExport
