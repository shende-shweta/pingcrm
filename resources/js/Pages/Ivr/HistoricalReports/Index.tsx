...
function HistoricalReportsIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/historical-reports/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HistoricalReports Index" />
      <h1 className="mb-4 text-2xl font-bold">HistoricalReports – Index</h1>
...
HistoricalReportsIndex.layout = authenticatedLayout
export default HistoricalReportsIndex
