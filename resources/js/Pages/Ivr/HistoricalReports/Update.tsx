...
function HistoricalReportsUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/historical-reports/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HistoricalReports Update" />
      <h1 className="mb-4 text-2xl font-bold">HistoricalReports – Update</h1>
...
HistoricalReportsUpdate.layout = authenticatedLayout
export default HistoricalReportsUpdate
