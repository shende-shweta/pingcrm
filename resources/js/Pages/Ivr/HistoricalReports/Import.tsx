...
function HistoricalReportsImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/historical-reports/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HistoricalReports Import" />
      <h1 className="mb-4 text-2xl font-bold">HistoricalReports – Import</h1>
...
HistoricalReportsImport.layout = authenticatedLayout
export default HistoricalReportsImport
