...
function ConferenceBridgeStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/conference-bridge/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ConferenceBridge Store" />
      <h1 className="mb-4 text-2xl font-bold">ConferenceBridge – Store</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel ConferenceBridge v4</div>
...
ConferenceBridgeStore.layout = authenticatedLayout
export default ConferenceBridgeStore
