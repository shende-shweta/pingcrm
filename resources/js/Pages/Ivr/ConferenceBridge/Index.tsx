...
function ConferenceBridgeIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/conference-bridge/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ConferenceBridge Index" />
      <h1 className="mb-4 text-2xl font-bold">ConferenceBridge – Index</h1>
...
ConferenceBridgeIndex.layout = authenticatedLayout
export default ConferenceBridgeIndex
