...
function ConferenceBridgeExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/conference-bridge/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ConferenceBridge Export" />
      <h1 className="mb-4 text-2xl font-bold">ConferenceBridge – Export</h1>
...
ConferenceBridgeExport.layout = authenticatedLayout
export default ConferenceBridgeExport
