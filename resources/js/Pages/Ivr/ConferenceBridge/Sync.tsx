...
function ConferenceBridgeSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/conference-bridge/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="ConferenceBridge Sync" />
      <h1 className="mb-4 text-2xl font-bold">ConferenceBridge – Sync</h1>
...
ConferenceBridgeSync.layout = authenticatedLayout
export default ConferenceBridgeSync
