...
function AfterHoursSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/after-hours/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AfterHours Sync" />
      <h1 className="mb-4 text-2xl font-bold">AfterHours – Sync</h1>
...
AfterHoursSync.layout = authenticatedLayout
export default AfterHoursSync
