...
function AfterHoursImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/after-hours/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AfterHours Import" />
      <h1 className="mb-4 text-2xl font-bold">AfterHours – Import</h1>
...
AfterHoursImport.layout = authenticatedLayout
export default AfterHoursImport
