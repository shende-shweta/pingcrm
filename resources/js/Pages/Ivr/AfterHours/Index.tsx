...
function AfterHoursIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AfterHours Index" />
      <h1 className="mb-4 text-2xl font-bold">AfterHours – Index</h1>
...
AfterHoursIndex.layout = authenticatedLayout
export default AfterHoursIndex
