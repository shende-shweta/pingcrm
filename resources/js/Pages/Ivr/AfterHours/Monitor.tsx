...
function AfterHoursMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/after-hours/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AfterHours Monitor" />
      <h1 className="mb-4 text-2xl font-bold">AfterHours – Monitor</h1>
...
AfterHoursMonitor.layout = authenticatedLayout
export default AfterHoursMonitor
