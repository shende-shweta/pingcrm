...
function AfterHoursStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="AfterHours Store" />
      <h1 className="mb-4 text-2xl font-bold">AfterHours – Store</h1>
...
AfterHoursStore.layout = authenticatedLayout
export default AfterHoursStore
