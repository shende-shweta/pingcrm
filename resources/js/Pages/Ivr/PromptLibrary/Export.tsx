...
function PromptLibraryExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/prompt-library/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="PromptLibrary Export" />
      <h1 className="mb-4 text-2xl font-bold">PromptLibrary – Export</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel PromptLibrary v4</div>
...
PromptLibraryExport.layout = authenticatedLayout
export default PromptLibraryExport
