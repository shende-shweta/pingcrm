...
function PromptLibraryUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/prompt-library/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="PromptLibrary Update" />
      <h1 className="mb-4 text-2xl font-bold">PromptLibrary – Update</h1>
...
PromptLibraryUpdate.layout = authenticatedLayout
export default PromptLibraryUpdate
