...
function PromptLibraryImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/prompt-library/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="PromptLibrary Import" />
      <h1 className="mb-4 text-2xl font-bold">PromptLibrary – Import</h1>
...
PromptLibraryImport.layout = authenticatedLayout
export default PromptLibraryImport
