...
function PromptLibraryStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/prompt-library/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="PromptLibrary Store" />
      <h1 className="mb-4 text-2xl font-bold">PromptLibrary – Store</h1>
...
PromptLibraryStore.layout = authenticatedLayout
export default PromptLibraryStore
