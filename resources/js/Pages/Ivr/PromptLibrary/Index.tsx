...
function PromptLibraryIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/prompt-library/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="PromptLibrary Index" />
      <h1 className="mb-4 text-2xl font-bold">PromptLibrary – Index</h1>
...
PromptLibraryIndex.layout = authenticatedLayout
export default PromptLibraryIndex
