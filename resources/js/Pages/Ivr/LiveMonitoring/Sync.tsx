...
function LiveMonitoringSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/live-monitoring/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LiveMonitoring Sync" />
      <h1 className="mb-4 text-2xl font-bold">LiveMonitoring – Sync</h1>
...
LiveMonitoringSync.layout = authenticatedLayout
export default LiveMonitoringSync
