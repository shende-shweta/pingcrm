...
function LiveMonitoringStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/live-monitoring/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LiveMonitoring Store" />
      <h1 className="mb-4 text-2xl font-bold">LiveMonitoring – Store</h1>
...
LiveMonitoringStore.layout = authenticatedLayout
export default LiveMonitoringStore
