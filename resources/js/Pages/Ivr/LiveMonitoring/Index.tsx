...
function LiveMonitoringIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/live-monitoring/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LiveMonitoring Index" />
      <h1 className="mb-4 text-2xl font-bold">LiveMonitoring – Index</h1>
...
LiveMonitoringIndex.layout = authenticatedLayout
export default LiveMonitoringIndex
