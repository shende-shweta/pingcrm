...
function LiveMonitoringUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/live-monitoring/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LiveMonitoring Update" />
      <h1 className="mb-4 text-2xl font-bold">LiveMonitoring – Update</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel LiveMonitoring v3</div>
...
LiveMonitoringUpdate.layout = authenticatedLayout
export default LiveMonitoringUpdate
