...
function LiveMonitoringDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/live-monitoring/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LiveMonitoring Destroy" />
      <h1 className="mb-4 text-2xl font-bold">LiveMonitoring – Destroy</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel LiveMonitoring v1</div>
...
LiveMonitoringDestroy.layout = authenticatedLayout
export default LiveMonitoringDestroy
