...
function CallbackSchedulerMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Monitor" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Monitor</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CallbackScheduler v4</div>
...
CallbackSchedulerMonitor.layout = authenticatedLayout
export default CallbackSchedulerMonitor
