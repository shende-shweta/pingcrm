...
function CallbackSchedulerStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Store" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Store</h1>
...
CallbackSchedulerStore.layout = authenticatedLayout
export default CallbackSchedulerStore
