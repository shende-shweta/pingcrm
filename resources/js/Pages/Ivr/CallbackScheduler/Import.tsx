...
function CallbackSchedulerImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Import" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Import</h1>
...
CallbackSchedulerImport.layout = authenticatedLayout
export default CallbackSchedulerImport
