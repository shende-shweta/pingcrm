...
function CallbackSchedulerExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Export" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Export</h1>
...
CallbackSchedulerExport.layout = authenticatedLayout
export default CallbackSchedulerExport
