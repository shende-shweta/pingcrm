...
function CallbackSchedulerSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Sync" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Sync</h1>
...
CallbackSchedulerSync.layout = authenticatedLayout
export default CallbackSchedulerSync
