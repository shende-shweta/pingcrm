...
function CallbackSchedulerDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/callback-scheduler/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallbackScheduler Destroy" />
      <h1 className="mb-4 text-2xl font-bold">CallbackScheduler – Destroy</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CallbackScheduler v3</div>
...
CallbackSchedulerDestroy.layout = authenticatedLayout
export default CallbackSchedulerDestroy
