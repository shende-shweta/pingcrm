...
function DidInventoryStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/did-inventory/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DidInventory Store" />
      <h1 className="mb-4 text-2xl font-bold">DidInventory – Store</h1>
...
DidInventoryStore.layout = authenticatedLayout
export default DidInventoryStore
