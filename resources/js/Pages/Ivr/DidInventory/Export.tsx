...
function DidInventoryExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/did-inventory/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DidInventory Export" />
      <h1 className="mb-4 text-2xl font-bold">DidInventory – Export</h1>
...
DidInventoryExport.layout = authenticatedLayout
export default DidInventoryExport
