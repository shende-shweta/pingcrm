...
function DidInventorySync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/did-inventory/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DidInventory Sync" />
      <h1 className="mb-4 text-2xl font-bold">DidInventory – Sync</h1>
...
DidInventorySync.layout = authenticatedLayout
export default DidInventorySync
