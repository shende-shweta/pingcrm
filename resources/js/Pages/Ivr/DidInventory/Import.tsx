...
function DidInventoryImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/did-inventory/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DidInventory Import" />
      <h1 className="mb-4 text-2xl font-bold">DidInventory – Import</h1>
...
DidInventoryImport.layout = authenticatedLayout
export default DidInventoryImport
