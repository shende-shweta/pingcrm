...
function DidInventoryIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/did-inventory/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DidInventory Index" />
      <h1 className="mb-4 text-2xl font-bold">DidInventory – Index</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel DidInventory v1</div>
...
DidInventoryIndex.layout = authenticatedLayout
export default DidInventoryIndex
