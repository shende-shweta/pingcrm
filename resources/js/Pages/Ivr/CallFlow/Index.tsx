...
function CallFlowIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallFlow Index" />
      <h1 className="mb-4 text-2xl font-bold">CallFlow – Index</h1>
...
CallFlowIndex.layout = authenticatedLayout
export default CallFlowIndex
