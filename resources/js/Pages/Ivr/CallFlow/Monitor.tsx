...
function CallFlowMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-flow/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallFlow Monitor" />
      <h1 className="mb-4 text-2xl font-bold">CallFlow – Monitor</h1>
...
CallFlowMonitor.layout = authenticatedLayout
