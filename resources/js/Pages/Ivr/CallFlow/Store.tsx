...
function CallFlowStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallFlow Store" />
      <h1 className="mb-4 text-2xl font-bold">CallFlow – Store</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CallFlow v3</div>
...
CallFlowStore.layout = authenticatedLayout
export default CallFlowStore
