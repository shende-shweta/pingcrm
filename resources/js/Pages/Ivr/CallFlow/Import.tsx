...
function CallFlowImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-flow/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallFlow Import" />
      <h1 className="mb-4 text-2xl font-bold">CallFlow – Import</h1>
...
CallFlowImport.layout = authenticatedLayout
export default CallFlowImport
