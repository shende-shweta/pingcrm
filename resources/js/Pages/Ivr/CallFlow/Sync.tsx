...
function CallFlowSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallFlow Sync" />
      <h1 className="mb-4 text-2xl font-bold">CallFlow – Sync</h1>
...
CallFlowSync.layout = authenticatedLayout
export default CallFlowSync
