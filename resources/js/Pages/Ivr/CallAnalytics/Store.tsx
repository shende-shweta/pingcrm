...
function CallAnalyticsStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-analytics/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallAnalytics Store" />
      <h1 className="mb-4 text-2xl font-bold">CallAnalytics – Store</h1>
...
CallAnalyticsStore.layout = authenticatedLayout
export default CallAnalyticsStore
