...
function CallAnalyticsSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-analytics/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallAnalytics Sync" />
      <h1 className="mb-4 text-2xl font-bold">CallAnalytics – Sync</h1>
...
CallAnalyticsSync.layout = authenticatedLayout
export default CallAnalyticsSync
