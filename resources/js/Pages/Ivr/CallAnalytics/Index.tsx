...
function CallAnalyticsIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-analytics/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallAnalytics Index" />
      <h1 className="mb-4 text-2xl font-bold">CallAnalytics – Index</h1>
...
CallAnalyticsIndex.layout = authenticatedLayout
