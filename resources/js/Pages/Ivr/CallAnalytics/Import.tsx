...
function CallAnalyticsImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-analytics/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallAnalytics Import" />
      <h1 className="mb-4 text-2xl font-bold">CallAnalytics – Import</h1>
...
CallAnalyticsImport.layout = authenticatedLayout
export default CallAnalyticsImport
