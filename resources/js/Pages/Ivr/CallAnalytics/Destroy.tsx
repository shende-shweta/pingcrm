...
function CallAnalyticsDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-analytics/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallAnalytics Destroy" />
      <h1 className="mb-4 text-2xl font-bold">CallAnalytics – Destroy</h1>
...
CallAnalyticsDestroy.layout = authenticatedLayout
export default CallAnalyticsDestroy
