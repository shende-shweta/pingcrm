...
function SurveyEngineDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Destroy" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Destroy</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel SurveyEngine v3</div>
...
SurveyEngineDestroy.layout = authenticatedLayout
export default SurveyEngineDestroy
