...
function SurveyEngineMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Monitor" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Monitor</h1>
...
SurveyEngineMonitor.layout = authenticatedLayout
export default SurveyEngineMonitor
