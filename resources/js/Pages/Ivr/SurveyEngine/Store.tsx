...
function SurveyEngineStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Store" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Store</h1>
...
SurveyEngineStore.layout = authenticatedLayout
export default SurveyEngineStore
