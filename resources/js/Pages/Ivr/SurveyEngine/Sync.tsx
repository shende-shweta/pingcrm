...
function SurveyEngineSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Sync" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Sync</h1>
...
SurveyEngineSync.layout = authenticatedLayout
export default SurveyEngineSync
