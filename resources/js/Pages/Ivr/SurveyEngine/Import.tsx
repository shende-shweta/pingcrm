...
function SurveyEngineImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Import" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Import</h1>
...
SurveyEngineImport.layout = authenticatedLayout
export default SurveyEngineImport
