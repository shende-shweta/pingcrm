...
function SurveyEngineIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/survey-engine/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SurveyEngine Index" />
      <h1 className="mb-4 text-2xl font-bold">SurveyEngine – Index</h1>
...
SurveyEngineIndex.layout = authenticatedLayout
export default SurveyEngineIndex
