...
function RateDeckImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/rate-deck/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="RateDeck Import" />
      <h1 className="mb-4 text-2xl font-bold">RateDeck – Import</h1>
...
RateDeckImport.layout = authenticatedLayout
export default RateDeckImport
