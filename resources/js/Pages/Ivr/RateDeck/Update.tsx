...
function RateDeckUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/rate-deck/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="RateDeck Update" />
      <h1 className="mb-4 text-2xl font-bold">RateDeck – Update</h1>
...
RateDeckUpdate.layout = authenticatedLayout
export default RateDeckUpdate
