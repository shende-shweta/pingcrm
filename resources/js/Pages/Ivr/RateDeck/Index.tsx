...
function RateDeckIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="RateDeck Index" />
      <h1 className="mb-4 text-2xl font-bold">RateDeck – Index</h1>
...
RateDeckIndex.layout = authenticatedLayout
export default RateDeckIndex
