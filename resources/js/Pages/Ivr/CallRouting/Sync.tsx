...
function CallRoutingSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Sync" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Sync</h1>
...
CallRoutingSync.layout = authenticatedLayout
export default CallRoutingSync
