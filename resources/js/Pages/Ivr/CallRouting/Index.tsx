...
function CallRoutingIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Index" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Index</h1>
...
CallRoutingIndex.layout = authenticatedLayout
export default CallRoutingIndex
