...
function CallRoutingDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Destroy" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Destroy</h1>
...
CallRoutingDestroy.layout = authenticatedLayout
export default CallRoutingDestroy
