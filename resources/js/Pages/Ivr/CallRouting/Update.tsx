...
function CallRoutingUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Update" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Update</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CallRouting v2</div>
...
CallRoutingUpdate.layout = authenticatedLayout
export default CallRoutingUpdate
