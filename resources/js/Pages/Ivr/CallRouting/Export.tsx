...
function CallRoutingExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Export" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Export</h1>
...
CallRoutingExport.layout = authenticatedLayout
export default CallRoutingExport
