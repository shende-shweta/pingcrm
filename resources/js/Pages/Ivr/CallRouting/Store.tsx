...
function CallRoutingStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-routing/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRouting Store" />
      <h1 className="mb-4 text-2xl font-bold">CallRouting – Store</h1>
...
CallRoutingStore.layout = authenticatedLayout
export default CallRoutingStore
