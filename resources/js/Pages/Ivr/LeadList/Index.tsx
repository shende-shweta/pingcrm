...
function LeadListIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/lead-list/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LeadList Index" />
      <h1 className="mb-4 text-2xl font-bold">LeadList – Index</h1>
...
LeadListIndex.layout = authenticatedLayout
export default LeadListIndex
