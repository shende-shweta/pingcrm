...
function LeadListImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/lead-list/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LeadList Import" />
      <h1 className="mb-4 text-2xl font-bold">LeadList – Import</h1>
...
LeadListImport.layout = authenticatedLayout
export default LeadListImport
