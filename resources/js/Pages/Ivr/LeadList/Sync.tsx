...
function LeadListSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/lead-list/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="LeadList Sync" />
      <h1 className="mb-4 text-2xl font-bold">LeadList – Sync</h1>
...
LeadListSync.layout = authenticatedLayout
export default LeadListSync
