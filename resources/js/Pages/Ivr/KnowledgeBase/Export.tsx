...
function KnowledgeBaseExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/knowledge-base/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="KnowledgeBase Export" />
      <h1 className="mb-4 text-2xl font-bold">KnowledgeBase – Export</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel KnowledgeBase v2</div>
...
KnowledgeBaseExport.layout = authenticatedLayout
export default KnowledgeBaseExport
