...
function KnowledgeBaseSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/knowledge-base/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="KnowledgeBase Sync" />
      <h1 className="mb-4 text-2xl font-bold">KnowledgeBase – Sync</h1>
...
KnowledgeBaseSync.layout = authenticatedLayout
export default KnowledgeBaseSync
