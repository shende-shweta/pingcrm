...
function KnowledgeBaseImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/knowledge-base/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="KnowledgeBase Import" />
      <h1 className="mb-4 text-2xl font-bold">KnowledgeBase – Import</h1>
...
KnowledgeBaseImport.layout = authenticatedLayout
