...
function KnowledgeBaseStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/knowledge-base/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="KnowledgeBase Store" />
      <h1 className="mb-4 text-2xl font-bold">KnowledgeBase – Store</h1>
...
KnowledgeBaseStore.layout = authenticatedLayout
