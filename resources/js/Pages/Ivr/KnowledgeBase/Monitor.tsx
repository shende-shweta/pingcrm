...
function KnowledgeBaseMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/knowledge-base/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="KnowledgeBase Monitor" />
      <h1 className="mb-4 text-2xl font-bold">KnowledgeBase – Monitor</h1>
...
KnowledgeBaseMonitor.layout = authenticatedLayout
