...
function EmergencyRouteStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/emergency-route/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Store" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Store</h1>
...
EmergencyRouteStore.layout = authenticatedLayout
export default EmergencyRouteStore
