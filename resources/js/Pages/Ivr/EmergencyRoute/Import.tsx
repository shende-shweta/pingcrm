...
function EmergencyRouteImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/emergency-route/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Import" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Import</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel EmergencyRoute v3</div>
...
EmergencyRouteImport.layout = authenticatedLayout
export default EmergencyRouteImport
