...
function EmergencyRouteExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/emergency-route/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Export" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Export</h1>
...
EmergencyRouteExport.layout = authenticatedLayout
export default EmergencyRouteExport
