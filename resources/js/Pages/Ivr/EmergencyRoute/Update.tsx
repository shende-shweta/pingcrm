...
function EmergencyRouteUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/emergency-route/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Update" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Update</h1>
...
EmergencyRouteUpdate.layout = authenticatedLayout
export default EmergencyRouteUpdate
