...
function EmergencyRouteIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Index" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Index</h1>
...
EmergencyRouteIndex.layout = authenticatedLayout
export default EmergencyRouteIndex
