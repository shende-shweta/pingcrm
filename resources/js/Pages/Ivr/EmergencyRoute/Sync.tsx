...
function EmergencyRouteSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/emergency-route/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="EmergencyRoute Sync" />
      <h1 className="mb-4 text-2xl font-bold">EmergencyRoute – Sync</h1>
...
EmergencyRouteSync.layout = authenticatedLayout
export default EmergencyRouteSync
