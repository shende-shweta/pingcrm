...
function BusinessHoursStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/business-hours/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BusinessHours Store" />
      <h1 className="mb-4 text-2xl font-bold">BusinessHours – Store</h1>
...
BusinessHoursStore.layout = authenticatedLayout
