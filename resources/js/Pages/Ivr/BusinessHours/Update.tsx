...
function BusinessHoursUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/business-hours/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BusinessHours Update" />
      <h1 className="mb-4 text-2xl font-bold">BusinessHours – Update</h1>
...
BusinessHoursUpdate.layout = authenticatedLayout
