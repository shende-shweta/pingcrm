...
function BusinessHoursIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/business-hours/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BusinessHours Index" />
      <h1 className="mb-4 text-2xl font-bold">BusinessHours – Index</h1>
...
BusinessHoursIndex.layout = authenticatedLayout
export default BusinessHoursIndex
