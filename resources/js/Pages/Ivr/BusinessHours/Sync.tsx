...
function BusinessHoursSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/business-hours/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BusinessHours Sync" />
      <h1 className="mb-4 text-2xl font-bold">BusinessHours – Sync</h1>
...
BusinessHoursSync.layout = authenticatedLayout
export default BusinessHoursSync
