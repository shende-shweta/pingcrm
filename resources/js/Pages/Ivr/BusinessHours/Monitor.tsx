...
function BusinessHoursMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/business-hours/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BusinessHours Monitor" />
      <h1 className="mb-4 text-2xl font-bold">BusinessHours – Monitor</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel BusinessHours v3</div>
...
BusinessHoursMonitor.layout = authenticatedLayout
export default BusinessHoursMonitor
