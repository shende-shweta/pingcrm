...
function CampaignDialerSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Sync" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Sync</h1>
...
CampaignDialerSync.layout = authenticatedLayout
export default CampaignDialerSync
