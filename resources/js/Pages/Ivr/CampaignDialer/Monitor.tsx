...
function CampaignDialerMonitor({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/monitor?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Monitor" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Monitor</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CampaignDialer v4</div>
...
CampaignDialerMonitor.layout = authenticatedLayout
export default CampaignDialerMonitor
