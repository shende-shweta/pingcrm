...
function CampaignDialerExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Export" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Export</h1>
...
CampaignDialerExport.layout = authenticatedLayout
export default CampaignDialerExport
