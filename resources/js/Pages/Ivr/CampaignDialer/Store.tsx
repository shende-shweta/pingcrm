...
function CampaignDialerStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Store" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Store</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CampaignDialer v2</div>
...
CampaignDialerStore.layout = authenticatedLayout
export default CampaignDialerStore
