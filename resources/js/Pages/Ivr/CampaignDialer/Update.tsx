...
function CampaignDialerUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Update" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Update</h1>
...
CampaignDialerUpdate.layout = authenticatedLayout
export default CampaignDialerUpdate
