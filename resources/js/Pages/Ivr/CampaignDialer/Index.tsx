...
function CampaignDialerIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/campaign-dialer/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CampaignDialer Index" />
      <h1 className="mb-4 text-2xl font-bold">CampaignDialer – Index</h1>
...
CampaignDialerIndex.layout = authenticatedLayout
export default CampaignDialerIndex
