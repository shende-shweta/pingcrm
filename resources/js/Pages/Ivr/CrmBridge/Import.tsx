...
function CrmBridgeImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/crm-bridge/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CrmBridge Import" />
      <h1 className="mb-4 text-2xl font-bold">CrmBridge – Import</h1>
...
CrmBridgeImport.layout = authenticatedLayout
export default CrmBridgeImport
