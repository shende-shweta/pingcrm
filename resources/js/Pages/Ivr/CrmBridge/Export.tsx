...
function CrmBridgeExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/crm-bridge/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CrmBridge Export" />
      <h1 className="mb-4 text-2xl font-bold">CrmBridge – Export</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel CrmBridge v4</div>
...
CrmBridgeExport.layout = authenticatedLayout
export default CrmBridgeExport
