...
function CrmBridgeIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/crm-bridge/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CrmBridge Index" />
      <h1 className="mb-4 text-2xl font-bold">CrmBridge – Index</h1>
...
CrmBridgeIndex.layout = authenticatedLayout
export default CrmBridgeIndex
