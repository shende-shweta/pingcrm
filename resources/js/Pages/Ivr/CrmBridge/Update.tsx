...
function CrmBridgeUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/crm-bridge/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CrmBridge Update" />
      <h1 className="mb-4 text-2xl font-bold">CrmBridge – Update</h1>
...
CrmBridgeUpdate.layout = authenticatedLayout
export default CrmBridgeUpdate
