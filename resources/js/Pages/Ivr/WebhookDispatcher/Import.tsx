...
function WebhookDispatcherImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/webhook-dispatcher/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WebhookDispatcher Import" />
      <h1 className="mb-4 text-2xl font-bold">WebhookDispatcher – Import</h1>
...
WebhookDispatcherImport.layout = authenticatedLayout
export default WebhookDispatcherImport
