...
function WebhookDispatcherExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/webhook-dispatcher/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WebhookDispatcher Export" />
      <h1 className="mb-4 text-2xl font-bold">WebhookDispatcher – Export</h1>
...
WebhookDispatcherExport.layout = authenticatedLayout
export default WebhookDispatcherExport
