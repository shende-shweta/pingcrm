...
function WhisperCoachUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/whisper-coach/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WhisperCoach Update" />
      <h1 className="mb-4 text-2xl font-bold">WhisperCoach – Update</h1>
...
WhisperCoachUpdate.layout = authenticatedLayout
export default WhisperCoachUpdate
