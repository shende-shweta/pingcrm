...
function WhisperCoachExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/whisper-coach/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WhisperCoach Export" />
      <h1 className="mb-4 text-2xl font-bold">WhisperCoach – Export</h1>
...
WhisperCoachExport.layout = authenticatedLayout
export default WhisperCoachExport
