...
function WhisperCoachDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/whisper-coach/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WhisperCoach Destroy" />
      <h1 className="mb-4 text-2xl font-bold">WhisperCoach – Destroy</h1>
...
WhisperCoachDestroy.layout = authenticatedLayout
export default WhisperCoachDestroy
