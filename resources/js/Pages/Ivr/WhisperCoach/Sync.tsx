...
function WhisperCoachSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/whisper-coach/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WhisperCoach Sync" />
      <h1 className="mb-4 text-2xl font-bold">WhisperCoach – Sync</h1>
...
WhisperCoachSync.layout = authenticatedLayout
export default WhisperCoachSync
