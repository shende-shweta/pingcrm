...
function WhisperCoachIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/whisper-coach/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="WhisperCoach Index" />
      <h1 className="mb-4 text-2xl font-bold">WhisperCoach – Index</h1>
...
WhisperCoachIndex.layout = authenticatedLayout
export default WhisperCoachIndex
