...
function TrunkGroupStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/trunk-group/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TrunkGroup Store" />
      <h1 className="mb-4 text-2xl font-bold">TrunkGroup – Store</h1>
...
TrunkGroupStore.layout = authenticatedLayout
export default TrunkGroupStore
