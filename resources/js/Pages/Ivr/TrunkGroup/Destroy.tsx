...
function TrunkGroupDestroy({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/trunk-group/destroy?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TrunkGroup Destroy" />
      <h1 className="mb-4 text-2xl font-bold">TrunkGroup – Destroy</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel TrunkGroup v4</div>
...
TrunkGroupDestroy.layout = authenticatedLayout
export default TrunkGroupDestroy
