...
function TrunkGroupSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/trunk-group/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TrunkGroup Sync" />
      <h1 className="mb-4 text-2xl font-bold">TrunkGroup – Sync</h1>
...
TrunkGroupSync.layout = authenticatedLayout
export default TrunkGroupSync
