...
function TrunkGroupImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/trunk-group/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TrunkGroup Import" />
      <h1 className="mb-4 text-2xl font-bold">TrunkGroup – Import</h1>
...
TrunkGroupImport.layout = authenticatedLayout
export default TrunkGroupImport
