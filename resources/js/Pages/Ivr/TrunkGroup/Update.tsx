...
function TrunkGroupUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/trunk-group/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="TrunkGroup Update" />
      <h1 className="mb-4 text-2xl font-bold">TrunkGroup – Update</h1>
...
TrunkGroupUpdate.layout = authenticatedLayout
export default TrunkGroupUpdate
