...
function BillingMeterIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/billing-meter/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BillingMeter Index" />
      <h1 className="mb-4 text-2xl font-bold">BillingMeter – Index</h1>
...
BillingMeterIndex.layout = authenticatedLayout
export default BillingMeterIndex
