...
function BillingMeterSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/billing-meter/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BillingMeter Sync" />
      <h1 className="mb-4 text-2xl font-bold">BillingMeter – Sync</h1>
...
BillingMeterSync.layout = authenticatedLayout
export default BillingMeterSync
