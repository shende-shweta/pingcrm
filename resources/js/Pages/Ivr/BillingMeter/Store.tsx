...
function BillingMeterStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/billing-meter/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BillingMeter Store" />
      <h1 className="mb-4 text-2xl font-bold">BillingMeter – Store</h1>
...
BillingMeterStore.layout = authenticatedLayout
export default BillingMeterStore
