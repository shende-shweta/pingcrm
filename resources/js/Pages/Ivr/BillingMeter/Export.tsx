...
function BillingMeterExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/billing-meter/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="BillingMeter Export" />
      <h1 className="mb-4 text-2xl font-bold">BillingMeter – Export</h1>
...
BillingMeterExport.layout = authenticatedLayout
export default BillingMeterExport
