...
function CallRecordingUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-recording/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRecording Update" />
      <h1 className="mb-4 text-2xl font-bold">CallRecording – Update</h1>
...
CallRecordingUpdate.layout = authenticatedLayout
