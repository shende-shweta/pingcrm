...
function CallRecordingExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-recording/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRecording Export" />
      <h1 className="mb-4 text-2xl font-bold">CallRecording – Export</h1>
...
CallRecordingExport.layout = authenticatedLayout
export default CallRecordingExport
