...
function CallRecordingImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/call-recording/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="CallRecording Import" />
      <h1 className="mb-4 text-2xl font-bold">CallRecording – Import</h1>
...
CallRecordingImport.layout = authenticatedLayout
export default CallRecordingImport
