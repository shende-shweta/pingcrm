...
function SystemConfigImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/system-config/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="SystemConfig Import" />
      <h1 className="mb-4 text-2xl font-bold">SystemConfig – Import</h1>
...
SystemConfigImport.layout = authenticatedLayout
