...
function HolidayCalendarIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/holiday-calendar/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HolidayCalendar Index" />
      <h1 className="mb-4 text-2xl font-bold">HolidayCalendar – Index</h1>
...
HolidayCalendarIndex.layout = authenticatedLayout
