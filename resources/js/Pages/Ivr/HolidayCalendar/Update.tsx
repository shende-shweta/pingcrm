...
function HolidayCalendarUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/holiday-calendar/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HolidayCalendar Update" />
      <h1 className="mb-4 text-2xl font-bold">HolidayCalendar – Update</h1>
...
HolidayCalendarUpdate.layout = authenticatedLayout
export default HolidayCalendarUpdate
