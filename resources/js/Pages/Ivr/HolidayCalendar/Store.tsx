...
function HolidayCalendarStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/holiday-calendar/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="HolidayCalendar Store" />
      <h1 className="mb-4 text-2xl font-bold">HolidayCalendar – Store</h1>
...
HolidayCalendarStore.layout = authenticatedLayout
