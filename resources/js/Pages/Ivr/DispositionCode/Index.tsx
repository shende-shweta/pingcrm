...
function DispositionCodeIndex({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/index?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Index" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Index</h1>
...
DispositionCodeIndex.layout = authenticatedLayout
export default DispositionCodeIndex
