...
function DispositionCodeUpdate({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/update?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Update" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Update</h1>
      ...
      <div className="mb-4 rounded border border-dashed border-gray-400 p-3 text-sm">Legacy panel DispositionCode v3</div>
...
DispositionCodeUpdate.layout = authenticatedLayout
export default DispositionCodeUpdate
