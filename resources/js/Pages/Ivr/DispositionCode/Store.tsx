...
function DispositionCodeStore({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/store?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Store" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Store</h1>
...
DispositionCodeStore.layout = authenticatedLayout
export default DispositionCodeStore
