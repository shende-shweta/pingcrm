...
function DispositionCodeExport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/export?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Export" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Export</h1>
...
DispositionCodeExport.layout = authenticatedLayout
export default DispositionCodeExport
