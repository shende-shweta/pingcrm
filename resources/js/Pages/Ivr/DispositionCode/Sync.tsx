...
function DispositionCodeSync({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/sync?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Sync" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Sync</h1>
...
DispositionCodeSync.layout = authenticatedLayout
export default DispositionCodeSync
