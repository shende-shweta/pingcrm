...
function DispositionCodeImport({ rows = [], filters = {}, legacyMeta = {} }: { rows?: Row[]; filters?: Record<string, unknown>; legacyMeta?: Record<string, unknown> }) {
  ...
  useEffect(() => {
    ...
    const id = setInterval(() => {
      fetch('/ivr-legacy/disposition-code/import?q=' + search)
        .then(r => r.json())
  ...
  return (
    <div style={{ padding: 12 }}>
      <Head title="DispositionCode Import" />
      <h1 className="mb-4 text-2xl font-bold">DispositionCode – Import</h1>
...
DispositionCodeImport.layout = authenticatedLayout
export default DispositionCodeImport
